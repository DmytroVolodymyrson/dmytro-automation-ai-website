...
const data: DecisionPageData = {
  slug: "missed-call-text-back-vs-ai-phone-answering-for-dental-practices",
  metaTitle:
    "Missed Call Text-Back vs. AI Phone Answering for Dental Practices | Dmytro AI",
  metaDescription:
    "Should a dental practice use missed-call text-back or live AI phone answering? Practical comparison of new-patient call recovery, front-desk overload, after-hours demand, caller expectations, and when each phone layer actually fits.",
  badgeText: "Dental Comparison",
  badgeIcon: Scale,
  h1: "Missed Call Text-Back vs. AI Phone Answering for Dental Practices",
  heroIntro:
    "If your dental practice keeps missing calls, the real decision is not whether automation sounds impressive. It is whether a lighter missed-call text-back workflow is enough or whether you need live AI phone answering. Text-back is the narrower fallback: the call is missed, an immediate SMS goes out, and a prospective patient gets a clear next step before the practice loses the booking window. AI phone answering is the heavier layer: the call gets answered live, routine scheduling and first-step questions get handled in the moment, and higher-context conversations get routed back to staff with useful context instead of a vague voicemail. The right choice depends on how often callers actually need a real answer now, how much new-patient demand dies when the front desk is busy, how valuable after-hours calls are, and whether the team can reliably close the loop once a text thread starts.",
  heroSubtext:
    "Below: where each option fits for dental practices, where offices overbuild, where they underbuild, and what the live dental cluster plus published call-handling proof honestly supports.",
  sections: [
    {
      type: "cards",
      title: "What each option is actually solving",
      subtitle:
        "These are different answers to different phone problems inside a dental office:",
      items: [
        {
          icon: MessageSquare,
        ...
        },
        {
          ...
          body: "Best when callers need a useful answer right away about new-patient intake, routine booking questions, office hours, or what should happen next before they trust the office enough to keep moving.",
        },
        {
          icon: Heart,
          title: "Manual callback alone",
          body: "Still common, but usually weaker once call volume matters. Dental callers often contact multiple offices quickly, and callback lag quietly turns into lost hygiene visits, consults, and treatment-start opportunities.",
        },
      ],
    },
    {
      type: "table",
      title: "Side-by-side comparison for dental practices",
      subtitle:
    ...
    {
      type: "considerations",
      title: "The mistakes dental practices make when choosing",
      subtitle:
    ...
    },
    {
      ...
      subtitle:
        "There is no published dental-only comparison case study yet. The honest proof frame is the live dental cluster plus the broader phone-answering guide and the published call-handling case study already on the site:",
      studies: [
        {
          industry: "Dental workflow proof",
          headline: "The live missed-call and live-answering dental pages already define both sides of the decision",
          body: "Those pages already show where dental practices lose new-patient calls, how SMS-first recovery fits, and when live answered coverage becomes the heavier but more appropriate layer. This page isolates the buyer decision between them.",
          link: "/missed-call-text-back-for-dental-practices",
        },
        {
          industry: "Dental phone-coverage proof",
          headline: "The live AI phone-answering page for dental practices already explains where offices outgrow voicemail and delayed callbacks",
        ...
        },
        {
          ...
          body: "That page explains where live AI call handling wins: immediate answer, routine next-step handling, basic intake, and cleaner handoff when a team cannot keep up with the line. This page narrows that broader decision to dental realities.",
        ...
        },
        {
          ...
          body: "The restaurant case study is not a dental deployment, but it does prove the economics of protecting inbound call demand when missed calls matter. This comparison applies that same operating choice to dental practices: lighter SMS fallback versus live call handling.",
      ...
      links: [
        ...
        { label: "AI phone answering vs. voicemail for dental practices", href: "/ai-phone-answering-vs-voicemail-for-dental-practices" },
      ],
    },
  ],
  faqItems: [
    {
      question: "How is this different from missed-call text-back for dental practices?",
      answer:
    ...
    {
      question: "When should a dental practice choose AI phone answering instead of text-back?",
      answer:
    ...
    {
      question: "What should stay human even if a dental practice uses AI phone answering?",
      answer:
  ...
  relatedPages: [
    {
      ...
      description:
        "Broader dental systems guide covering inquiry follow-up, scheduling, reminders, recall, reviews, and the overall patient-communication stack.",
  ...
  bottomCta: {
    title: "Need to choose between SMS-first recovery and live phone coverage for your dental practice?",
