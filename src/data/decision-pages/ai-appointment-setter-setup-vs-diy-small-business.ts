    ...
    },
    {
      ...
      studies: [
        ...
        },
        {
          ...
          body: "The AI voice-agent lead-qualification guide plus the vehicle accessories CRM case study reinforce the same point: a working appointment setter is not just about answering first. It has to qualify cleanly, log correctly, and hand off reliably so the team does not inherit a new cleanup problem.",
