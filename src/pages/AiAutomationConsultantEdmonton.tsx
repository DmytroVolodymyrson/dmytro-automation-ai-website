...
const faqItems = [
  {
    question: "Do I need to be in Edmonton to work with you?",
    answer:
      "No. We work remotely with businesses across North America. That said, we understand the Edmonton market, the industries here, and the pace at which local businesses operate. If you are based in Edmonton or Alberta, you are working with someone who knows the context.",
  },
  {
...
const AiAutomationConsultantEdmonton = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>AI Automation Consultant Edmonton | Dmytro AI</title>
        <meta
          name="description"
          content="AI automation consultant serving Edmonton businesses. Custom automations for lead follow-up, scheduling, CRM, and operations. Practical solutions, fixed pricing, real results."
        />
        <link
          rel="canonical"
          href="https://www.dmytroai.com/ai-automation-consultant-edmonton"
        />
        <meta
          property="og:title"
          content="AI Automation Consultant Edmonton | Dmytro AI"
        />
        <meta
          property="og:description"
          content="AI automation consultant serving Edmonton businesses. Practical solutions, fixed pricing, real results."
        />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content="https://www.dmytroai.com/ai-automation-consultant-edmonton"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ProfessionalService",
            name: "Dmytro AI - AI Automation Consultant Edmonton",
            description:
              "AI automation consulting for Edmonton businesses. Custom automations for lead follow-up, scheduling, CRM workflows, and operations.",
            url: "https://www.dmytroai.com/ai-automation-consultant-edmonton",
            areaServed: {
              "@type": "City",
              name: "Edmonton",
              containedInPlace: {
      ...
      <main className="pt-24 md:pt-28">
          ...
          <div className="container-tight relative z-10">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-5 tracking-tight">
                AI Automation Consultant for Edmonton Businesses
              </h1>
        ...
        <Section className="bg-secondary/30">
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 tracking-tight">
            What we automate for Edmonton businesses
          </h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                body: "If you operate multiple locations in Edmonton or across Alberta, we build systems that keep scheduling, lead routing, and reporting consistent across all of them.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
        ...
        <Section>
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 tracking-tight">
            Edmonton industries we work with
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mb-10 leading-relaxed">
            Edmonton's economy runs on services, healthcare, trades, and professional firms.
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl">
            {[
              ...
              { name: "Law firms, accounting practices, and clinics", detail: "Consultation booking, intake, reminders, client follow-up" },
              { name: "Construction, trades, and field service", detail: "Dispatch, quoting, vendor coordination, reporting" },
        ...
        <Section>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 text-center leading-relaxed">
            Practical answers about working with an AI automation consultant in Edmonton
          </p>
...
export default AiAutomationConsultantEdmonton;
