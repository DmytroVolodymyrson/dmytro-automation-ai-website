...
const faqItems = [
  {
    ...
    answer:
      "No. We work remotely with businesses across North America. We are based in Alberta and serve clients across Canada, including Vancouver and the rest of British Columbia. Everything is delivered remotely with the same quality and turnaround.",
  },
  {
...
const AiAutomationConsultantVancouver = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>AI Automation Consultant Vancouver | Dmytro AI</title>
        <meta
          name="description"
          content="AI automation consultant serving Vancouver businesses. Custom automations for lead follow-up, scheduling, CRM, and operations. Remote delivery, fixed pricing, real results."
        />
        <link
          rel="canonical"
          href="https://www.dmytroai.com/ai-automation-consultant-vancouver"
        />
        <meta
          property="og:title"
          content="AI Automation Consultant Vancouver | Dmytro AI"
        />
        <meta
          property="og:description"
          content="AI automation consultant serving Vancouver businesses. Remote delivery, fixed pricing, real results."
        />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content="https://www.dmytroai.com/ai-automation-consultant-vancouver"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ProfessionalService",
            name: "Dmytro AI - AI Automation Consultant Vancouver",
            description:
              "AI automation consulting for Vancouver businesses. Custom automations for lead follow-up, scheduling, CRM workflows, and operations. Remote delivery from Alberta.",
            url: "https://www.dmytroai.com/ai-automation-consultant-vancouver",
            areaServed: {
              "@type": "City",
              name: "Vancouver",
              containedInPlace: {
      ...
      <main className="pt-24 md:pt-28">
          ...
          <div className="container-tight relative z-10">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-5 tracking-tight">
                AI Automation Consultant for Vancouver Businesses
              </h1>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                body: "If you operate multiple locations in Vancouver or across British Columbia, we build systems that keep scheduling, lead routing, and reporting consistent across all of them.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
        ...
        <Section>
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mb-10 leading-relaxed">
            Vancouver's economy runs on services, tech, real estate, and
            professional firms. These are the industries where automation
            delivers the clearest ROI:
          </p>
        ...
        <Section>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 text-center leading-relaxed">
            Practical answers about working with an AI automation consultant serving Vancouver
          </p>
...
export default AiAutomationConsultantVancouver;
