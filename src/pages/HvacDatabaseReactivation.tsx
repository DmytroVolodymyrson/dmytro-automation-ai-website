  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 md:pt-28">
          ...
          <div className="container-tight relative z-10">
            ...
            >
              ...
              <p className="text-base text-muted-foreground leading-relaxed mb-8">
                Most residential HVAC companies are sitting on thousands of
                dollars in their existing database. This is the fastest way to
                unlock it.
              </p>
              <Button
                size="lg"
        ...
        <Section>
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 tracking-tight">
            Why this is the lowest-risk way to generate revenue
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mb-10 leading-relaxed">
            You're not buying leads. You're not running ads. You're not hiring.
            This is working contacts you already have with a system that runs
            itself:
          </p>
            ...
            {[
              {
                icon: DollarSign,
                title: "Zero ad spend",
                body: "Every contact in your database was already acquired — through past marketing, referrals, or word of mouth. Reactivation has no customer acquisition cost. The only investment is the build.",
              },
              {
                icon: Clock,
              ...
              },
              {
                ...
                body: "The reactivation system is a one-time build. You can run it once and stop, or set it to run continuously. There's no monthly retainer required — though most operators want ongoing campaigns once they see the results.",
              },
              {
                icon: Database,
                title: "Your data, your relationships",
                body: "These are people who chose your company before. You're not cold-calling strangers. Reactivation converts at higher rates because trust already exists.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
        ...
        <Section className="bg-secondary/30">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mb-10 leading-relaxed">
            These are results from similar database and outreach automation
            builds. The core pattern — reaching dormant contacts with relevant,
            timed messaging — applies directly to HVAC reactivation:
          </p>
          <div className="grid gap-6 md:grid-cols-2 max-w-4xl">
            {[
              {
                headline: "5,600+ dormant contacts organized and activated",
                body: "An e-commerce business had years of leads scattered across spreadsheets with no outreach system. We built a full CRM pipeline, cleaned the data, and launched automated sequences — tripling their effective outreach capacity. For HVAC, the same process turns a messy database into a structured reactivation engine.",
          ...
          <div className="relative z-10 container-tight">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-2">
                Book a 30-minute call. I'll look at what's sitting in your
                database, estimate the reactivation opportunity, and tell you
                exactly what a campaign would look like — whether we work
                together or not.
              </p>
              <p className="text-sm text-muted-foreground">
                No ad spend. No new leads to buy. Just revenue from contacts you
                already own.
              </p>
            </motion.div>
