...
const faqItems = [
  {
    question: "Do I need to be in Ottawa to work with you?",
    answer:
      "No. We work remotely with businesses across North America. We are based in Alberta and serve clients across Canada, including Ottawa and the rest of Ontario. Everything is delivered remotely with the same quality and turnaround.",
  },
  {
...
const AiAutomationConsultantOttawa = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>AI Automation Consultant Ottawa | Dmytro AI</title>
        <meta
          name="description"
          content="AI automation consultant serving Ottawa businesses. Custom automations for lead follow-up, scheduling, CRM, and operations. Remote delivery, fixed pricing, real results."
        />
        <link
          rel="canonical"
          href="https://www.dmytroai.com/ai-automation-consultant-ottawa"
        />
        <meta
          property="og:title"
          content="AI Automation Consultant Ottawa | Dmytro AI"
        />
        <meta
          property="og:description"
          content="AI automation consultant serving Ottawa businesses. Remote delivery, fixed pricing, real results."
        />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content="https://www.dmytroai.com/ai-automation-consultant-ottawa"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ProfessionalService",
            name: "Dmytro AI - AI Automation Consultant Ottawa",
            description:
              "AI automation consulting for Ottawa businesses. Custom automations for lead follow-up, scheduling, CRM workflows, and operations. Remote delivery from Alberta.",
            url: "https://www.dmytroai.com/ai-automation-consultant-ottawa",
            areaServed: {
              "@type": "City",
              name: "Ottawa",
              containedInPlace: {
      ...
      <main className="pt-24 md:pt-28">
          ...
          <div className="container-tight relative z-10">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-5 tracking-tight">
                AI Automation Consultant for Ottawa Businesses
              </h1>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                body: "If you operate multiple locations in Ottawa or across Ontario, we build systems that keep scheduling, lead routing, and reporting consistent across all of them.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
        ...
        <Section>
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mb-10 leading-relaxed">
            Ottawa's economy runs on government services, professional firms,
            technology, and a strong local trades sector. These are the
            industries where automation delivers the clearest ROI:
          </p>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl">
            {[
              { name: "Professional services and consulting firms", detail: "Proposal follow-up, client onboarding, scheduling, document collection" },
              { name: "Dental and medical clinics", detail: "Patient booking, intake, reminders, recall campaigns" },
              ...
              { name: "Real estate teams and property management", detail: "Lead qualification, showing coordination, tenant communication" },
              { name: "Construction and general contractors", detail: "Job intake, estimate follow-up, dispatch coordination, subcontractor scheduling" },
            ].map((biz, i) => (
              <motion.div
                key={biz.name}
          ...
          <div className="grid gap-6 md:grid-cols-2 max-w-4xl">
            {[
              ...
              },
              {
                ...
                body: "WheelsFeels, a Houston vehicle camping systems brand, had thousands of untouched leads. We built automated follow-up sequences, tripled team capacity without hiring, and lifted conversions 185%.",
        ...
        <Section>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 text-center leading-relaxed">
            Practical answers about working with an AI automation consultant serving Ottawa
          </p>
...
export default AiAutomationConsultantOttawa;
