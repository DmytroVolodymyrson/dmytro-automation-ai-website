          ...
          <div className="grid gap-6 md:grid-cols-2 max-w-4xl">
            {[
              ...
              },
              {
                ...
                body: "A Houston vehicle accessories e-commerce brand had thousands of untouched leads. We built automated follow-up sequences, tripled team capacity without hiring, and lifted conversions 185%.",
