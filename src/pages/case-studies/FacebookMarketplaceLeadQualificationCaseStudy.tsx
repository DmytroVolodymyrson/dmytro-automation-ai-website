...
import { manuliftMarketplaceLeadQualificationCaseStudy as caseStudy } from "@/data/caseStudies";

const FacebookMarketplaceLeadQualificationCaseStudy = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Facebook Marketplace AI Lead Qualification — Case Study | Dmytro AI</title>
        <meta name="description" content="How a heavy-equipment sales team used n8n, Apify, GPT-4o-mini, and Google Sheets to classify Facebook Marketplace leads, reduce manual review, and expand review capacity." />
        <link rel="canonical" href="https://www.dmytroai.com/case-studies/facebook-marketplace-ai-lead-qualification" />
        <meta property="og:title" content="Facebook Marketplace AI Lead Qualification — Case Study" />
        <meta property="og:description" content="An n8n workflow that enriches Marketplace listings, classifies seller fit with AI, and sends review-ready leads back to Google Sheets." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.dmytroai.com/case-studies/facebook-marketplace-ai-lead-qualification" />
        <meta property="og:image" content="https://www.dmytroai.com/images/manulift-facebook-marketplace-ai-lead-qualification.png" />
        <script type="application/ld+json">{JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Article",
          "headline": "Facebook Marketplace AI Lead Qualification Workflow",
          "description": "How a heavy-equipment sales team used n8n, Apify, GPT-4o-mini, and Google Sheets to classify Facebook Marketplace leads and reduce manual review.",
          "author": { "@id": "https://www.dmytroai.com/#person" },
          "publisher": { "@id": "https://www.dmytroai.com/#business" },
          "mainEntityOfPage": "https://www.dmytroai.com/case-studies/facebook-marketplace-ai-lead-qualification",
          "image": "https://www.dmytroai.com/images/manulift-facebook-marketplace-ai-lead-qualification.png",
          "keywords": ["Facebook Marketplace lead generation", "n8n automation", "AI lead qualification", "Apify", "Google Sheets"]
        })}</script>
      </Helmet>
      <Navbar />
      ...
      <main className="pt-24 md:pt-28 pb-16 md:pb-24">
        <div className="container-tight space-y-10 md:space-y-14">
          ...
          >
            <img
              src="/images/manulift-facebook-marketplace-ai-lead-qualification.png"
              alt="Facebook Marketplace AI lead qualification n8n workflow infographic"
              loading="eager"
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed max-w-3xl">
              The team gets a cleaner review sheet instead of a raw pile of Marketplace listings. AI handles the first-pass seller classification, the workflow records the reasoning, and humans spend their time on the leads most likely to be worth pursuing.
            </p>
            <div className="grid gap-4 sm:grid-cols-3">
              {caseStudy.results.map((result) => (
                <div key={result.label} className="rounded-2xl border border-border/60 bg-background/70 p-5">
                  <p className="text-sm font-semibold uppercase tracking-wide text-accent mb-2">{result.label}</p>
                  <p className="font-display text-2xl font-bold text-foreground mb-2">{result.value}</p>
                  <p className="text-sm text-muted-foreground leading-relaxed">{result.sub}</p>
                </div>
              ))}
            </div>
          ...
          >
            <h2 className="font-display text-3xl md:text-4xl font-bold text-center">
              Want a lead workflow like this?
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto">
              Book a free strategy call to see which lead source, qualification logic, and handoff system makes sense for your business.
            </p>
            <div className="bg-card px-6 pt-6 lg:pt-0 pb-6 rounded-2xl shadow-card border border-border/50 overflow-hidden">
              <iframe
                ...
                loading="lazy"
                scrolling="no"
                id="dmytro-automation-booking-manulift-cs"
...
export default FacebookMarketplaceLeadQualificationCaseStudy;
